...
from online_fresh_02.settings import APIKEY
...
class UesrViewset(mixins.UpdateModelMixin,mixins.CreateModelMixin,viewsets.GenericViewSet,mixins.RetrieveModelMixin):
    """
    用户
    """
    ...
    def create(self, request, *args, **kwargs):
        ...
        payload = jwt_payload_handler(user)   #生成token的两个重要步骤，一是payload，二是encode
